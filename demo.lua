...
MultiPathNet = {
    ...
    np=5,si=-2.5,sf=.5,ss=.5,dm=false,img=nil,thr=0.5,maxsize=600,sharpmask_path='data/models/sharpmask.t7',multipath_path='data/models/resnet18_integral_coco.t7',
    sharpmask = torch.load(sharpmask_path).model
