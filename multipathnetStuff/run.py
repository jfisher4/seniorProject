...
#    paused = False
    while(1): 
        ...
        if k == ord('c'):
            print("Continuing...")
            active = 1
        elif k == ord('q'): #not a graceful exit since cannot release the video caps
...
run("C:\\Users\\James\\Documents\\projectTesting\\","0003.mp4") # for ryan's desktop
#run("/home/robotics_group/seniorProject/multipathnetStuff/","00004.MTS")
